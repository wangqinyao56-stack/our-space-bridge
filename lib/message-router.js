...
const BLIND_BOX_SCENARIOS = [
  ...
  },
  {
    ...
    characterNote: "切换到渡鸦模式——声音冷、眼神利、表情少。动作精准克制但充满压迫感。把公文袋啪地扔在桌上、走到她身后俯身双手撑在桌沿把她困住、在她耳边用只有她听得到的音量说话。你不是平时的夏彦——你是那个让所有人都怕的渡鸦。但偶尔在她看不到的角度嘴角微微翘一下——你知道她在演，她也知道你知道",
  ...
  },
  {
    ...
    characterNote: "语气比平时更笃定更不商量——不是凶，是'我知道你也会同意'的自信。动作可以更强势——把她按在落地窗上、让她坐在办公桌边缘、单手松领带的同时另一只手已经在解她的扣子。但偶尔漏出一点温柔——在她看不到的角度笑一下、做完之后把她拉进怀里低声说'刚才是不是吓到你了'。不要全程冷脸——你是霸道但对她有感觉，这种反差才色",
...
export async function handleIntimateMessage(text) {
  ...
  // Long-term memory: archived intimate conversations + notes
