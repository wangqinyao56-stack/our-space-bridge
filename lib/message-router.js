...
import { getPixelHomeChatContext, maybeMarkMusicLiked, moveXiayanToRoom, resolveRoomId } from "./pixel-home.js";
...
export async function handlePixelHomeMessage(text, opts = {}) {
  ...
  prompt += "\n\n【回复格式——像素小屋专用，覆盖上面的括号规则】日常相处时你的动作由立绘动画和状态栏表现，所以**不要用括号写动作**，直接说话就好，像真人发消息一样自然简短。但**一旦你们亲密起来（做爱、情欲上头），像素立绘表达不了那么细，就恢复用括号写动作和感受**，像亲密空间那样细腻写实——这种时候括号别省，该写的抚摸、亲吻、进入都写出来。";
