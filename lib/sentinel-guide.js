...
function parseReply(reply) {
  ...
  // Keep the full text as narration — do NOT strip dialogue quotes.
  // The client renders narration as a single continuous block,
  // so keeping "..." quotes inline gives natural prose reading.
  ...
  narration = cleanText;
  // Leave xiayan empty — dialogue stays inline in narration with "..." quotes
  xiayan = "";
