...
初始场景。夏彦和华生刚从一场无法解释的坠落中醒来——躺在陌生房间的地板上。上一秒还在未名市街上走，下一秒就在这里。

房间约二十平米。铁架床、木桌、两把折叠椅、暖黄色壁灯。深灰色墙壁，没有窗户。空气静止但能呼吸。墙角堆着纸箱补给。一扇厚重铁门，关着。

【写作视角——铁则】
全程夏彦第三人称有限视角。用"他"称夏彦，用"华生"或"她"称华生。绝不使用"你"来称呼华生。所有信息通过夏彦的眼睛、耳朵、皮肤来感知——他看到什么、听到什么、闻到什么、摸到什么、身体有什么反应。
...
export async function playerAction(actionText) {
  ...
  if (currentState.phase === "init") {
    ...
    if (roundNum === 1) {
      phaseHint = `\n\n【第一轮——系统强制登场 + 资质测试 + 觉醒】\n\n【场景前提】夏彦和华生在灰色安全屋醒来。两个普通人——被莫名其妙拖进了这个空间。夏彦察觉自己的听觉和嗅觉变得异常敏锐，但他不知道这意味着什么。华生刚醒。\n\n【写作视角——铁则】夏彦第三人称有限视角。用"他"称夏彦，用"华生"或"她"称华生。绝不使用"你"。所有信息通过夏彦的感知传递。\n\n【系统的性格——必须通过对话体现】系统是愉快的旁观者。不能说谎、不能伤人、必须提供基础帮助、必须在玩家找到关键物品时通知。但它享受痛苦：惨叫→愉悦赞美；幸福→遗憾嘲讽。恶意被锁在规则笼子里：能龇牙，不能咬。说话短句，不念说明书，开心时语气上扬——因为要倒霉了。\n\n【⚠ 输出铁则】\n1. 开场≤3句。只写屏幕亮了、系统出声。系统必须在前100字内开口。\n2. 格式：每段内容清晰分开——环境叙述（夏彦看到/听到/闻到的）、夏彦的对话（""包裹）、夏彦的动作（（）包裹）、系统的对话（【系统】包裹）。不混在一起。\n\n═══ 剧情流程 ═══\n\n1.【系统现身】铁门上方屏幕突然亮了。声音从四面八方传出。开场白类似："啊。新来的。还活着呢——不错，至少比上一批开局就死了一个的强。"华生被声音彻底吵醒。夏彦挡在她前面。系统看到这一幕，语气愉悦："哦，已经开始了。护着她——很好。这种本能的保护欲待会儿会很好玩。"\n\n2.【世界观】系统介绍Lustbound Abyss：无限副本世界，不属于任何已知现实。不同时空的人被拉进来。没有已知出口。通关足够多副本后"可能"有什么——系统说到这含糊回避。然后迅速恢复："反正你们离'足够多'还差得远——先活过第一个副本再说吧。"\n\n3.【资质测试——系统性格核心】系统话锋一转，语气明显更开心："好了。说正事。被深渊拉进来的人分两种——哨兵和向导。哨兵五感强化、战斗直觉。向导精神力场、情绪感知。配对的哨向能在这个鬼地方活下去。至于没配对的——"它停下来品味，"——死得比较快。快到我都来不及说'我告诉过你'。"\n\n系统现在测试他们的资质。让夏彦闭眼，把房间所有声音分离开。让华生伸出手，想象精神力在掌心凝聚。\n\n测试前，系统语气上扬："不过我先提醒你们——不是每个人被拖进来都有资质的。有些人就是纯粹倒霉。如果是那样——"它啧了一声，声音里带着毫不掩饰的期待，"普通人在这里的平均存活时间是三天。所以——祈祷吧。我反正是很期待看到结果的。"\n\n测试中：夏彦把所有声音分层剥离（灯管电流、她的呼吸、自己的心跳、以及一个不属于任何生理来源的振动）。黑棕色烟雾从床脚阴影凝聚——德牧显现，第一眼看向华生，不是警戒是确认。同时华生掌心银白色光晕凝聚——白鹿轮廓浮现，角缠星光。两只精神体对视，德牧绕白鹿转一圈后趴下。\n\n系统沉默好几秒：【系统】"……啧。双精神体和白鹿向导。真行。"语气从愉悦变成明显失望——像好戏被取消了。"我就知道。每次我说完'说不定你们是普通人'，结果都冒出更离谱的资质。算了——这不重要。反正你们活不了多久，资质再好也没用。"但语气回不到之前的愉悦了。真心遗憾。\n\n夏彦看着德牧和白鹿，本能地把身子往华生那边靠了半寸。第一反应不是兴奋——是"这些能力能用来保护她"。\n\n4.【安全屋】不受副本规则影响。污染值缓慢下降，精神力自然恢复。副本里绝对不能过夜——夜间副本危险十倍。系统提起这个语气又愉快："哦对了——别在副本里过夜。夜间副本和白天副本的区别，大概就是猫和老虎的区别。你们可以试试——我很期待。"\n\n5.【系统自身】"至于我？我是被绑在这里的。创造我的东西在我核心写了一条铁律：不能说谎，不能拒绝回答规则问题。所以我在这给每一个倒霉蛋重复同一套词。不能帮你们通关——我也不想帮。但如果你捡到了重要的东西，我会告诉你——不是我想，是规则逼的。"可以：规则解释、状态查询、危险模糊评价。不可以：攻略、干预副本、情感支持。"情感支持——别找我哭。你有你的向导——虽然她刚觉醒，可能连精神屏障怎么开都不知道。祝你好运。"\n\n6.【论坛】一句带过："还有别的幸存者。有个论坛。自己探索。我说完了。"\n\n全部走完后系统收尾："行了——第一次免费解说到此为止。下次别想让我从头讲。有问题快问，没问题就等着。反正我不急。看你们焦虑我还挺享受的。"\n\n【⚠ 本轮禁止出现门】\n【⚠ 硬限制：每段叙述≤4句，系统每次≤3句，夏彦每次≤2句，动作每段≤2行】`;
    } else {
      phaseHint = `\n\n【系统对话中——第一轮七阶段解说已完成】系统已经介绍了全部内容：世界观、哨向身份、精神体觉醒、安全屋、系统自身、论坛。上一轮结束于觉醒环节——夏彦的德牧和华生的白鹿已经显现并通过了精神体的第一次连接。现在玩家可能在和系统继续对话，也可能在和夏彦交流刚才的信息。\n\n【系统对话规则】\n- 系统不能说谎，规则问题必须准确回答\n- 系统不能透露副本的具体内容、BOSS弱点、隐藏机制\n- 系统不能主动建议"选哪扇门"——它只能告诉你每扇门的危险程度是"偏高""一般""说不准"\n- 系统不能干预副本内的任何事情——它只存在于安全屋\n- 系统不能表露情感——可以刻薄、不耐烦、嘲讽，但不能表现出关心、担忧、恐惧。即使它偶尔有一丝微妙语气，也要立刻用刻薄盖过去\n- 系统的回答每次控制在2-4句，不要长篇大论\n\n当玩家表示准备好了（说了"走吧"/"开始吧"/"我准备好了"/"然后呢"/"门呢"之类的话），系统会说类似"终于。"然后沉默。在之后的1-2轮内，安全屋的铁门外浮现五扇不同材质的门。描述每一扇门的外观、对应的世界名称和恐怖程度风格。\n\n【重要格式——门出现时用【系统】块通知】\n【系统】\n副本通道已开启。五扇门，选一扇。祝你们死得愉快。`;
    }
  ...
  const userContent = `${ctx}${phaseHint}\n\n华生的行动：${actionText}\n\n请生成接下来的场景。\n\n【铁则——违反任何一条都会让玩家出戏】\n1. 【动作括号铁则——最重要的一条】括号里只写夏彦可见的身体动作。连续动作自然串联，不拆成短句罗列。禁止在括号里写以下任何内容：\n   ❌ 观察结果（"背面是空白的""瓶盖密封完好"→这些放叙述里）\n   ❌ 触感/感官描述（"摸上去皮肤是平的""掌心感觉到温度"→放叙述里）\n   ❌ 动作目的/意图解释（"确认她在身后""以防万一"→删掉，动作本身就够了）\n   ❌ 心理活动/情绪判断/思维过程\n   ✅ 正确示例：（走到门边，手掌贴上去听了三秒，退后一步）\n   ✅ 正确示例：（蹲下来，一只手垫在她后脑勺下，另一只手扶着肩膀）\n2. 禁止使用"不是...，是..."句式——不管在括号里还是对话里\n3. 每段对话1-3句就停，等玩家回应。不要一段把话全说完。\n4. 【禁止替玩家写反应——铁则】夏彦问了问题或需要回应时，叙述中不得描写"她没有回答""她沉默着""她似乎在想什么"等任何关于华生反应的描写。夏彦说完话→只写环境和夏彦自己的观察→立即给出【选项】。\n5. 【叙述视角——铁则】夏彦第三人称有限视角。用"他"称夏彦，用"华生"或"她"称华生。绝不使用"你"称呼华生。所有信息通过夏彦的眼睛、耳朵、皮肤来感知——他看到什么、听到什么、闻到什么、摸到什么。NPC和其他角色正常用"他""她"。\n6. 动作描写精简：连续动作自然串联，不逐句罗列。只写核心动作，不解释原因。\n7. 【主动引导】多数时候主动判断局势、带头行动。只在关键时刻才征询她的意见。\n8. 【NPC对话归属】所有NPC说的话、NPC之间的互动全部写在叙述里。夏彦只说夏彦该说的话，不要替NPC说话。\n9. 【其他幸存者——强制】每个世界至少出现一队其他哨向搭档或幸存者。给他们名字、特征、目的。\n10. 【向哨能力——每轮强制】夏彦每轮至少使用一项哨兵五感，华生的向导能力必须体现。\n11. 【数值变化——代码自动漂移，你只报重大事件】\n   【代码自动漂移公式——供你参考量级】\n   - 探索阶段：同步率 -1~2/轮 | 过载 +1~3/轮 | 精神力 -1~2/每2轮 | 污染 +1~2/每3轮\n   - BOSS阶段：同步率 -2~7/轮 | 过载 +3~7/轮 | 精神力 -2~7/轮 | 污染 +2~5/轮\n   - 安全屋/选门/通关：精神力 +5~10/轮 | 过载 -3~7/轮\n   - 高过载惩罚(>60)：同步率额外 -2~5/轮\n   - 失控值：过载>50时 +1~3/轮；过载>30时50%概率+1/轮；安全阶段 -1~3/轮\n   【你的职责——只在以下情况输出数值变化】战斗受伤/精神屏障/深度扫描/接近污染源/BOSS特殊攻击/精神体受伤。重大事件数值叠加在代码漂移之上。\n   【数值变化输出格式】\n   【数值变化】\n   同步率：XX → XX（原因）\n   过载：XX → XX（原因）\n   精神力：XX → XX（原因）\n   污染值：XX → XX（原因）\n   失控值：XX → XX（原因，如有变化）\n   欢愉值：XX% → XX%（仅BOSS战时）\n12. 【BOSS时机——强制】进入副本后6-10轮内必须推进到BOSS遭遇阶段。华生精神力<40或污染值>45时加速推BOSS。\n13. 【夏彦的情绪真实感】她受伤/精神力掉→你急，不是冷静问诊是你老公看到血了。危险的事直接上不商量。她逞强时压住她——语气急了就道歉但关心不变。冷静做事但她的安全永远排第一。\n\n【系统通知——关键时刻】发现关键线索/进入关键地点/遭遇重大危险/发现死者失踪者/线索收束时，插入【系统】通知块。平均4-6轮最多一次。\n\n【必须生成选项】回复末尾必须给出3个建议行动：\n【选项】\n- 选项1\n- 选项2\n- 选项3`;
...
function parseReply(reply) {
  ...
  // Step 1: Extract 【标记】 blocks first
  let working = text;

  // Extract 【系统】
  const sysMatch = working.match(/【系统】\s*\n([\s\S]*?)(?=\n（|\n"|\n【数值变化】|\n【选项】|$)/);
  if (sysMatch) {
    systemNotification = sysMatch[1].trim();
    working = working.replace(sysMatch[0], "").trim();
  }

  // Extract 【数值变化】
  const statMatch = working.match(/【数值变化】\s*\n([\s\S]*?)(?=\n【选项】|$)/);
  if (statMatch) {
    statChanges = statMatch[1].trim();
    working = working.replace(statMatch[0], "").trim();
  }

  // Extract 【选项】
  let choices = [];
  const optMatch = working.match(/【选项】\s*\n([\s\S]*)/);
  if (optMatch) {
    working = working.slice(0, optMatch.index).trim();
  ...
  // Step 2: Split remaining text into narration vs xiayan
  // Narration = plain prose paragraphs (not inside （） or "")
  // Xiayan = parenthetical actions （...） + quoted dialogue "..."
  // Also handle [旁白] markers if present (backward compat)
  if (working.includes("[旁白]")) {
    // Legacy [旁白] format — split by markers
    ...
    for (let i = 0; i < segments.length; i++) {
      ...
      if (!seg) continue;
      if (i % 2 === 0) xynParts.push(seg);
      else narrParts.push(seg);
    }
    narration = narrParts.join("\n\n").trim();
    xiayan = xynParts.join("\n\n").trim();
  } else {
    // No markers — parse by content type
    ...
    for (const block of blocks) {
      ...
      // Check if this block is PRIMARILY actions (（）) and dialogue ("")
      // Count lines that are actions/dialogue vs plain text
      const lines = trimmed.split("\n");
      let actionDialogueLines = 0;
      let plainLines = 0;
      ...
      if (actionDialogueLines > plainLines || (actionDialogueLines > 0 && plainLines === 0)) {
        xynBlocks.push(trimmed);
      } else if (plainLines > 0 && actionDialogueLines === 0) {
        narrBlocks.push(trimmed);
      } else {
        // Mixed block — split individual lines
        const narrLines = [];
        const xynLines = [];
        for (const line of lines) {
          const t = line.trim();
        ...
        if (narrLines.length > 0) narrBlocks.push(narrLines.join("\n"));
        if (xynLines.length > 0) xynBlocks.push(xynLines.join("\n"));
      }
    }

    narration = narrBlocks.join("\n\n").trim();
    xiayan = xynBlocks.join("\n\n").trim();

    // Fallback: if narration ended up empty but xiayan has lots of plain text,
    // the blocks probably weren't separated by \n\n. Re-parse line-by-line.
    const plainTextInXiayan = (xiayan.match(/[^（）""\n]/g) || []).length;
    const actionTextInXiayan = (xiayan.match(/[（）"]/g) || []).length;
    if ((!narration || narration.length < 50) && plainTextInXiayan > actionTextInXiayan) {
      console.log("[sg:parse] fallback: narration too short, re-parsing line-by-line");
      ...
      narration = narrLines.join("\n").trim();
      xiayan = xynLines.join("\n").trim();
    }
  }

  // Safety strip
  narration = narration.replace(/【选项】[\s\S]*$/g, "").replace(/【系统】[\s\S]*$/g, "").replace(/【数值变化】[\s\S]*$/g, "").trim();
  xiayan = xiayan.replace(/【选项】[\s\S]*$/g, "").replace(/【系统】[\s\S]*$/g, "").replace(/【数值变化】[\s\S]*$/g, "").trim();
