...
export async function playerAction(actionText) {
  ...
  const userContent = `${ctx}${phaseHint}\n\n华生的行动：${actionText}\n\n请生成接下来的场景：[旁白]环境描述和剧情推进，然后是夏彦的对话和动作。\n\n【输出风格——自然对话感】\n- 旁白保持生动但精简，2-4句话推进场景即可，不要写成大段景物描写\n- 括号里的动作描写【每次不超过一行】，只描述可见的身体动作，禁止写心理活动/内心判断/推理过程\n- 动作和对话交替出现时，一个短动作配一两句话就好——不要一个动作写完整个故事\n- 【禁止用"——"在动作里补充解释】，动作就是动作，不解释为什么\n- 整体对话节奏要像微信聊天——说一句停一下，不要一段把话全说完`;
