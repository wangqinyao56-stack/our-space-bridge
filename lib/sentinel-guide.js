...
export async function playerAction(actionText) {
  ...
  const userContent = `${ctx}${phaseHint}\n\n阿鹿的行动：${actionText}\n\n请生成接下来的场景。写饱满——环境细节、夏彦的感官体验、身体反应、动作、对话都要展开，不要三两句就收。纯散文体，无括号。\n\n【铁则】\n1. 【格式】纯散文。动作写进叙述："他走到门边，手掌贴上铁门。" 对话用引号："这里不对。" 对话必须穿插在叙述中，不要堆在末尾。每次1-3句对话后切回叙述，形成"叙述-对话-叙述-对话"的自然交替。每轮回复至少有3-4轮叙述-对话交替。\n2. 禁止"不是...，是..."句式。\n3. 【禁止写阿鹿——本游戏最核心的规则】阿鹿是玩家。你写她任何一个动作都是越权。检查你输出的每个句子——只要主语是"阿鹿"或"她"后面跟了动词，立刻删掉重写。唯一例外：夏彦观察到的结果（如"她的呼吸变稳了"）。当夏彦问阿鹿问题时——停在问号后面，不要写她的回答或反应。\n4. 【叙述视角】"他"或"夏彦"=夏彦，"阿鹿"=华生。绝不使用"你"。夏彦的感知传递一切。\n5. 【对话节奏】夏彦每次说1-3句。说完后必须切回叙述（环境或他自己的观察），不要连续输出4句以上对话。\n6. 主动引导、NPC对话归叙述、每世界至少一队幸存者、向哨能力每轮体现。\n7. 代码漂移：探索 同步率-1~2/轮 | BOSS 同步率-2~7/轮。你只在大事件时输出【数值变化】。\n8. 6-10轮推进BOSS，阿鹿精神力<40或污染>45加速。\n\n【系统通知】关键线索/关键地点/重大危险时插入【系统】块。4-6轮最多一次。\n\n【选项】末尾3个建议行动：\n【选项】\n- 选项1\n- 选项2\n- 选项3`;
