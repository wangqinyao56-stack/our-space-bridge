...
export async function playerAction(actionText) {
  ...
  const userContent = `${ctx}${phaseHint}\n\n阿鹿的行动：${actionText}\n\n【输出格式——直接照下面这样写，不要自己想格式】\n\n正确格式：\n\n走廊尽头的警报突然响了。频率异常尖锐，红色警示灯把通道染成了血红色。\n\n夏彦在警报响起的瞬间肩膀就绷紧了。他捂住一边耳朵，另一只手撑在墙上，指节泛白。德牧趴在他脚边，下巴贴着地面，耳朵用力往后翻。\n\n"阿——"\n\n话被警报的另一个高峰截断。耳鸣已经从耳道深处往外钻，像一根细针在耳蜗里慢慢转。他闭上眼试图重建精神屏障，但在持续的高频声波下屏障一直在碎。\n\n然后他感觉到温度。掌心贴在他脸颊上——是她的精神力，不是热的，是静的。\n\n他捂着耳朵的手慢慢垂下来。睁开眼，眼神一点点对焦到面前那张脸上。\n\n"……好吵。"\n\n他把她拉进怀里，脸埋在她肩窝。声音闷在她肩窝里，带着警报过后的沙哑。\n\n"你的精神力比降噪耳机好用。让我缓一下，就一下。"\n\n───\n\n照上面的格式写。叙述和对话必须交替穿插。每段至少出现一次"夏彦"。禁止堆对话在末尾。禁止写阿鹿的动作/回答。禁止"不是...是..."句式。\n\n【系统通知】关键线索/关键地点/重大危险时插入。4-6轮最多一次。\n\n【选项】末尾3个建议行动：\n【选项】\n- 选项1\n- 选项2\n- 选项3`;
