...
export async function playerAction(actionText) {
  ...
  if (currentState.phase === "exploring") {
    ...
    return {
      state: getPublicState(),
      reply: { narration: parsed.narration, xiayan: parsed.xiayan, systemNotification: finalSystemNotification, statChanges: parsed.statChanges, statUpdates, choices: parsed.choices },
