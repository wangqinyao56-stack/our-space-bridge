...
const WORLD_THEMES = [
  {
    name: "血色", emoji: "🩸",
    primary: "#C04020", primaryDim: "rgba(190,60,30,0.15)", accent: "#E06030",
    headerBg: "rgba(20,8,8,0.92)", statusBg: "rgba(20,8,8,0.85)",
    accentBg: "rgba(190,60,30,0.06)", accentBorder: "#8B2A18", accentDim: "rgba(224,96,48,0.15)",
    textHighlight: "#F0D8C8", textDim: "#C0A090",
  },
  {
    name: "暗紫", emoji: "🟣",
