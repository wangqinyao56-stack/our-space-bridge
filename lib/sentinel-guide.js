...
export async function playerAction(actionText) {
  ...
  if (currentState.phase === "init") {
    ...
    phaseHint = "\n\n玩家正在探索当前世界。紧凑推进场景——每轮至少一件实质性事件（新线索、新NPC、新威胁、新发现）。不要慢悠悠描写环境，2-3句定调后立刻推进。引入NPC或其他幸存者队伍，让世界感觉有人存在。【BOSS时机】6-10轮内必须推进到BOSS遭遇——线索收束/关键地点探索完/连续2-3轮无进展/华生精神力低于40或污染高于45时，立刻触发BOSS。不要让探索无限拖长。";
