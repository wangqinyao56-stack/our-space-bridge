...
export async function playerAction(actionText) {
  ...
  if (currentState.phase === "init") {
    ...
    if (roundNum === 1) {
      phaseHint = "\n\n【开场——坠落与系统初现】这是故事的第一轮。华生刚刚回复了你（夏彦）在第一轮中的关注和安抚。现在你必须推进到下一阶段：让【系统】声音在这片白色空间中响起。系统说：\"欢迎来到深渊。\"然后用它的方式开始解释——这是什么地方、你们为什么在这里、哨兵与向导意味着什么。记住系统的说话方式：像人，不念说明书。有停顿。说完核心信息后问玩家有什么想问的。系统说完之前，不要出现门。";
    } else {
      phaseHint = "\n\n【系统对话中】系统已经介绍了基本信息。现在玩家可能在和系统对话、提问。系统耐心回答规则相关的问题。当玩家表示准备好了（说了\"走吧\"/\"开始吧\"/\"我准备好了\"之类的话），系统会说\"好\"，然后沉默。五扇门在几秒后浮现。描述每一扇门的外观、对应的世界名称、风格、NPC类型和恐怖程度。等待玩家选择。";
    }
