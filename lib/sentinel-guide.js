...
export async function playerAction(actionText) {
  ...
  if (currentState.phase === "init") {
    ...
    phaseHint = `\n\n【⚠ 副本已通关——当前在安全屋结算阶段】\n\n世界已通关。你们已被传送回安全屋。此刻应做以下事情（可自由选择顺序）：\n1. 两人坐下来整理物品分类（华生用/夏彦用）\n2. 复盘刚才的副本\n3. 提醒阿鹿商城已自动打开，可以用积分购买道具\n\n【⚠ 强制——系统通知必须用【系统】块】\n通关结算信息、积分变化、战利品分类——这些系统级信息必须用【系统】块包裹，与周围叙述空行隔开。禁止把系统信息写在旁白叙述里。\n\n正确格式：\n\n【系统】\n🏆 副本通关！积分+45 | 累计通关:3个世界\n\n错误格式（禁止）：\n旁白里直接写"屏幕上弹出结算窗口，显示获得45积分"——这种要改成【系统】块。\n\n【重要】\n- 夏彦主动邀请做爱恢复——按"安全屋中的夏彦"规则\n- 商城已自动弹出，不要在叙述中替阿鹿写购物选择\n- 休息够了之后，夏彦问"要不要去看下一扇门？"`;
  }
