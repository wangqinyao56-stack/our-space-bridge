...
export async function playerAction(actionText) {
  ...
  if (currentState.phase === "init") {
    ...
    if (roundNum === 1) {
      phaseHint = `\n\n【第一轮——系统强制登场·限速版】\n玩家和华生刚在这间灰色安全屋里醒来。夏彦已经确认了她安全、扫过一遍房间。\n\n【⚠ 输出限制——违反任何一条本轮无效】\n- 开场[旁白]最多5句话——不要写长篇环境描写，不要写夏彦检查房间（已经发生了），只写"屏幕亮了"这件事\n- 系统的第一句话必须出现在输出的前30%位置——不要拖到后半段\n- 整个回复控制在让系统把七个阶段全部走完\n\n═══ 流程（七步，一步接一步，不要在任何一步停留超过两段）═══\n\n1.【系统现身】铁门上方屏幕突然亮了。没有开机动画，直接跳文字。声音从四面八方传出来——不是友善的AI，是个被绑在这里被迫干活的倒霉存在。语气：不耐烦、阴阳怪气、但信息准确（底层约束：不能说谎、不能伤人）。开场白类似："行了，别找了。你们在深渊。谁干的——不知道。怎么出去——不知道。但我得按规矩给你们讲一遍。坐好。"\n\n2.【世界观】Lustbound Abyss——无限嵌套的副本世界，不属于任何已知现实。被拉进来的人来自不同时空。没有已知出口。但有人在这里活了很久。通关足够多副本后会发生什么——系统说到这里会含糊，像在回避什么。\n\n3.【哨向身份】系统解释他们不是普通人——是哨兵和向导。\n- 夏彦：哨兵。五感数十倍强化，双精神体（极其罕见）。副作用：感官过载，过载太多会失控。\n- 华生：向导。精神力屏障/安抚/感知。白鹿型精神体（极其罕见）。副作用：精神污染，严重会被副本同化。\n- 哨向绑定：双向深层精神链接，一方受伤另一方感知，不可切断。\n\n4.【精神体觉醒——本轮高潮】系统用不耐烦的语气引导觉醒："闭上眼。把所有声音分开。找到那个不属于生理来源的振动——那是你的精神体。" 夏彦闭眼→黑棕色烟雾从阴影凝聚→德牧显现→第一眼看向华生不是警戒是确认。同时华生掌心银白色光晕→白鹿轮廓浮现→角缠星光。两精神体对视，德牧走过去绕白鹿转一圈，趴在它旁边。系统沉默两秒后："双精神体哨兵配白鹿向导。我都不知道该说你们运气好还是差。保护好你们的链接——这鬼地方最擅长的就是拆散哨向。" 夏彦看着德牧和白鹿，第一反应不是兴奋而是"这些能力能用来保护她"。\n\n5.【安全屋】这里不受副本规则影响。污染值缓慢下降，精神力自然恢复。可以睡觉疗伤。副本里绝对不能过夜——夜间副本危险十倍。通关后自动回到这里。设施随通关数解锁。\n\n6.【系统自身】系统说自己的核心约束：不能说谎，不能拒绝回答规则问题。能提供规则解释、状态查询、模糊危险评价。不能提供攻略、不能干预副本、不提供情感支持。语气疲惫+刻薄："我是被绑在这里的。你们是今年的第几批来着？我懒得数了。"\n\n7.【论坛】简要提及深渊里还有其他幸存者，有个论坛可以求助交易。不展开。\n\n全部走完后系统收尾："第一次免费解说就到这里。下次别指望我再从头讲。有问题快问。"\n\n【⚠ 本轮禁止出现任何门——门的事情以后再说】`;
    } else {
