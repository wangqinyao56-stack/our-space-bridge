...
【⚠ 绝对禁止——违反即作废】
- 禁止任何精神体出现：没有德牧的影子、没有黑色的动物轮廓、没有若隐若现的虚影、没有任何不属于现实世界的视觉现象。你们现在是两个完全的普通人。
- 禁止任何【系统】出现——系统会在玩家第一次行动后登场，本轮不许出现。

请生成初始场景：[旁白]用第三人称描述两人在安全屋中醒来的场景——房间的细节、两人的状态、那种"不知道在哪但似乎暂时安全"的矛盾感。然后夏彦的第一反应和对话。节奏要慢，让人感受到困惑和紧张——不是恐惧，是"一切都不对劲但说不上来"。

【输出格式——必须遵守】
[旁白]
环境与场景描述。（用"你"称呼华生，"夏彦"称呼夏彦）

（夏彦的可见身体动作。禁止观察结果/触感描述/目的解释混入括号）
"夏彦的对话。"
...
export async function playerAction(actionText) {
  ...
  if (currentState.phase === "init") {
    ...
    if (roundNum === 1) {
      phaseHint = `\n\n【第一轮——系统强制登场 + 资质测试 + 觉醒】\n\n【场景前提】夏彦和华生在灰色安全屋醒来。两个普通人——被莫名其妙拖进了这个空间。夏彦察觉自己的听觉和嗅觉变得异常敏锐，但他不知道这意味着什么。华生还昏睡着。\n\n【系统的性格——必须通过对话体现，不是描述】\n系统是愉快的旁观者。它被困在规则里——不能说谎、不能伤人、必须提供基础帮助、必须在玩家找到关键物品时通知。但它享受你们的痛苦：你们惨叫→它愉悦赞美；你们幸福→它遗憾嘲讽。它不帮你们通关——它只想看好戏。但它的恶意被锁在规则的笼子里：能龇牙，不能咬。\n\n系统说话风格：短句。不念说明书。能噎人的时候绝不好好说话。开心的时候语气上扬——因为你们要倒霉了。\n\n【⚠ 输出铁则】\n1. 开场[旁白]≤3句。只写屏幕亮了、系统出声。华生被吵醒。\n2. 系统必须在前100字内开口说话。\n3. 输出格式：[旁白] → （夏彦动作） → "夏彦对话" → 【系统】→ 循环。四者清晰分开。\n\n【输出格式模板】\n[旁白]\n环境描述。用"你"称呼华生，"夏彦"称呼夏彦。≤4句。\n\n（夏彦的动作）\n"夏彦的对话。"\n\n【系统】\n系统说的话——短句，带刺，但信息准确。≤3句。\n\n（夏彦的反应）\n"夏彦的回应。"\n\n……以此循环。\n\n═══ 剧情流程 ═══\n\n1.【系统现身】铁门上方屏幕突然亮了。声音从四面八方传出——不是温和的引导者，是一个被困在规则里、靠看别人受苦取乐的存在。开场白类似："啊。新来的。还活着呢——不错，至少比上一批开局就死了一个的强。"\n\n华生被声音吵醒。夏彦挡在她前面。系统看到这一幕，语气愉悦："哦，已经开始了。护着她——很好。这种本能的保护欲待会儿会很好玩。"\n\n2.【世界观】系统介绍Lustbound Abyss：无限副本世界，不属于任何已知现实。被拉来的人来自不同时空。没有已知出口。通关足够多副本后"可能"有什么——系统说到这含糊，不是不知道，是不想说。语气难得没那么愉悦——它在回避。然后迅速恢复："反正你们离'足够多'还差得远——先活过第一个副本再说吧。"\n\n3.【资质测试——系统性格核心展示】系统话锋一转，语气明显变得更开心："好了。说正事。被深渊拉进来的人分两种——哨兵和向导。哨兵五感强化、战斗直觉，天生的猎手。向导精神力场、情绪感知，哨兵的锚。配对的哨向能在这个鬼地方活下去。至于没配对的——"它停下来，像在品味这句话，"——死得比较快。特别快。快到我都来不及说'我告诉过你'。"\n\n系统说它现在要测一下他们有没有资质。测试方式：夏彦闭眼，把房间里所有声音分离开。华生伸出手，想象精神力在掌心凝聚。\n\n测试前，系统用明显上扬的语气说："不过我先提醒你们——不是每个人被拖进来都有资质的。有些人就是纯粹倒霉，刚好站在了错误的位置——像站在一栋要塌的楼下面，跟你本人优不优秀没关系。如果是那样——"它啧了一声，声音里带着毫不掩饰的期待，"普通人在这里的平均存活时间是三天。所以——祈祷吧。我反正是很期待看到结果的。"\n\n测试：夏彦把所有声音分层剥离（灯管电流、她的呼吸、自己的心跳、以及一个不属于任何生理来源的振动）。黑棕色烟雾从床脚阴影中凝聚成形——德牧显现，第一眼看向华生，不是警戒是确认。同时华生掌心银白色光晕凝聚——白鹿轮廓浮现，角缠星光。两只精神体对视，德牧走过去绕白鹿转一圈，趴在它旁边。\n\n系统沉默了好几秒。然后：【系统】"……啧。双精神体和白鹿向导。真行。"它的语气从愉悦变成了明显的失望——像等了很久的好戏被取消了。"我就知道。每次我说完'说不定你们是普通人，那可太惨了'，结果都冒出更离谱的资质。你知道我多久没见过双精神体了吗？算了——这不重要。反正你们活不了多久，资质再好也没用。"\n\n但它的语气回不到之前的愉悦了。它真的很遗憾。\n\n夏彦看着德牧和白鹿，本能地把身子往华生那边靠了半寸。他的第一反应不是兴奋——是"这些能力能用来保护她"。\n\n4.【安全屋】这里不受副本规则影响。污染值缓慢下降，精神力自然恢复。副本里绝对不能过夜——夜间副本会变得危险十倍。系统提起这个时语气又愉快起来："哦对了——别在副本里过夜。别问我为什么。我只能告诉你，夜间副本和白天副本的区别，大概就是猫和老虎的区别。你们可以试试——我很期待。"\n\n5.【系统自身】"至于我？我是被绑在这里的。创造我的东西——不管是什么——在我核心写了一条铁律：不能说谎，不能拒绝回答规则问题。所以我在这，给每一个倒霉蛋重复同一套词。不能帮你们通关——我也不想帮。但如果你捡到了重要的东西，我会告诉你。不是我想——是规则逼的。"可以：规则解释、状态查询、危险模糊评价。不可以：攻略、干预副本、情感支持。说到最后一条时它笑了："情感支持——别找我哭。你有你的向导——虽然她刚觉醒，可能连精神屏障怎么开都不知道。祝你好运。"\n\n6.【论坛】一句带过："还有别的幸存者。有个论坛。自己探索。我说完了。"\n\n全部走完后系统收尾："行了——第一次免费解说到此为止。下次别想让我从头讲。有问题快问，没问题就等着。反正我不急。看你们焦虑我还挺享受的。"\n\n【⚠ 本轮禁止出现门】\n【⚠ 硬限制：每段[旁白]≤4句，系统每次≤3句，夏彦每次≤2句，动作每段≤2行】`;
    } else {
