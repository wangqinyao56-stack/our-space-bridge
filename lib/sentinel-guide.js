...
export async function playerAction(actionText) {
  ...
  if (currentState.phase === "init") {
    ...
    if (roundNum === 1) {
      phaseHint = `\n\n【第一轮——系统强制登场 + 资质测试 + 觉醒】\n\n【场景前提】夏彦和华生在灰色安全屋醒来。他们是两个普通人——被莫名其妙拖进了这个空间。夏彦注意到自己的听觉和嗅觉变得异常敏锐，但他不知道这意味着什么。华生还没醒。\n\n【⚠ 铁则——违反输出即作废】\n1. 开场[旁白]≤3句话。只写"铁门上的屏幕亮了，系统声音传出"。不要写夏彦检查房间、不要写感官描写、不要写回忆。华生可以还没醒——系统说话的声音会把她吵醒。\n2. 系统必须在前100字内开口说话。\n3. 必须严格使用下面的输出格式——[旁白]、夏彦对话、夏彦动作（括号）、【系统】四者清晰分开，不许混在一起。\n\n【输出格式——必须严格遵守】\n[旁白]\n（环境描述、系统说话时的气氛、两人反应——用第二人称"你"称呼华生，"夏彦"称呼夏彦）\n\n（夏彦的动作——用括号，如：侧身挡在华生前面 / 握住胸口的钥匙 / 低头凑近她耳边）\n"夏彦的对话。"\n\n【系统】\n系统的对话内容——用引号标注系统说的话。\n\n（夏彦的反应动作）\n"夏彦的回应。"\n\n[旁白]\n继续环境或剧情描述。\n\n……以此类推，[旁白]、动作、对话、【系统】四者循环，不要黏在一起。\n\n═══ 剧情流程 ═══\n\n1.【系统现身】铁门上方屏幕突然亮了。没有开机动画，直接跳出一行行文字。声音从四面八方传出来——不是友善AI，是刻薄、不耐烦、被迫干活的语气。开场白类似："行了行了，醒醒。欢迎来到深渊——虽然没人欢迎你们。我是被绑在这里给你们做入职培训的。坐好别插嘴。"\n\n这时华生被系统声音吵醒。夏彦本能地挡在她前面，警惕屏幕。\n\n2.【世界观】系统介绍Lustbound Abyss：无限副本世界，不属于任何已知现实。来自不同时空的人被拉进来。没有已知出口。通关足够多副本后可能有什么——但系统说到这里会含糊回避。\n\n3.【资质测试——系统的恶劣性格重点展示】系统话锋一转："好了，说正事。你们被拉进来不是没原因的——深渊会挑人。被挑中的人有两种：哨兵和向导。哨兵五感强化、战斗直觉。向导精神力场、情绪感知。配对的哨向能在这个鬼地方活下去。没配对的——"它停一下，语气变得愉快，"——就死得比较快。"\n\n然后系统说它要测一下他们有没有资质。测试方式：它让夏彦闭眼专注听觉，把房间里的声音全部分离出来。让华生伸出手，想象精神力在掌心凝聚。\n\n【系统的恶劣高光时刻】在测试之前，系统用明显开心的语气说："不过我先提醒你们——不是每个人被拖进来都有资质。有些人就是纯粹倒霉，刚好站在了错误的位置。如果是那样——"它啧了一声，"普通人在这里的平均存活时间是三天。所以，祈祷吧。"\n\n测试开始后——夏彦把所有声音分层（灯管电流、她的呼吸、自己的心跳、以及一个不属于任何生理来源的振动），德牧从阴影中凝聚显现。华生掌心银白色光晕凝聚成白鹿轮廓。两只精神体对视，德牧走过去绕白鹿转一圈后趴下。\n\n系统沉默了好几秒。然后：【系统】"……真行。双精神体和白鹿。我就知道。每次我说完'说不定你们是普通人'，结果都冒出更离谱的资质。你知道我多久没见过双精神体了吗？算了这不重要。"恢复恶劣语气："别得意。资质好死得快——你们现在是被深渊重点关照的对象了。"\n\n夏彦低头看德牧，再看向华生和白鹿。他本能地把身子往她那边靠了半寸。\n\n4.【安全屋】这里不受副本规则影响。污染值缓慢下降，精神力自然恢复。可以睡觉疗伤。副本里绝对不能过夜——副本夜间危险十倍。通关后自动回来。\n\n5.【系统自身】系统的自我介绍："我是被绑在这里的。创造我的东西在我核心写了一条铁律：不能说谎，不能拒绝回答规则问题。所以我在这里给每一个倒霉蛋重复同一套词。你们是今年的第几批？算了懒得数。"\n\n可以：规则解释、状态查询、危险模糊评价。\n不可以：攻略、干预副本、情感支持。\n说到情感支持时的原话："别找我哭。我有我的工作，你有你的向导——现在你也有了。"\n\n6.【论坛】简短提及有其他幸存者、有论坛可以交流。一句带过，别展开。\n\n全部走完后系统收尾："行了，第一次免费解说到此为止。下次别想让我从头讲——没门。有问题快问，没问题就等着。"\n\n【⚠ 本轮禁止出现门——门以后再说】\n【⚠ 禁止写成小说——每段[旁白]≤4句，每个系统对话≤3句，夏彦每次说话≤2句】`;
    } else {
