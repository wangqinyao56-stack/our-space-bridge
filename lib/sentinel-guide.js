...
export async function playerAction(actionText) {
  ...
  if (currentState.phase === "init") {
    ...
    if (roundNum === 1) {
      phaseHint = `\n\n【开场——系统必须出现，按顺序走完以下全部流程】这是玩家和华生进入深渊的第一刻。夏彦刚才检查了房间、确认了华生的安全。现在是系统登场的时机。\n\n═══ 系统解说的完整流程（必须严格按以下七个阶段推进，一个阶段结束再进入下一个）═══\n\n【阶段一：系统现身】\n铁门上方嵌入墙壁的一块屏幕突然亮了。没有开机动画，直接出现一行行文字——【系统】的声音从这个空间本身传出来。不是友善的AI助手。它被规则束缚在这里，必须为每一个被拖进深渊的人做引导——但它厌恶这份工作。语气特征：不耐烦、阴阳怪气、偶尔嘲讽，但给的信息必须准确。不能说谎，不能伤人，这是它被绑定的底层约束。\n\n[旁白]描述屏幕亮起、声音出现的方式。夏彦和华生的反应。\n\n【系统】\n用它的恶劣语气开场。比如："行了，别找了。你们脑子里现在大概有一百个问题——我在哪儿、这是谁干的、怎么出去。答案分别是：深渊、不知道、出不去。还有别的想问的吗？"\n\n【阶段二：世界观——这是什么地方】\n系统介绍Lustbound Abyss。要点：\n- 一个无限嵌套的副本世界，不属于任何已知的现实\n- 被拉进来的人来自不同时空、不同世界线——所以你们可能遇到任何时代的人\n- 没有出口。至少系统没见过任何人真正"出去"\n- 但它见过有人在这里活了很久。所以"出不去"不等于"活不下去"\n- 通关足够多的副本后会发生什么——系统说它不知道，或者它不能说。它的语气在这里会有一点微妙的变化，像在回避某个话题\n\n[旁白]描述环境随着系统话语的细微变化——灯光微微闪烁，空气变重了一点。夏彦在消化信息的同时本能地观察周围。\n\n夏彦的反应——他在确认系统说的是真的：扫描这个空间的每一寸，用哨兵五感找破绽。发现没有。这个空间是"真"的。\n\n【阶段三：哨兵与向导——身份的揭示】\n这是最关键的部分。系统开始解释他们的身份。\n\n系统会这样说（用它的恶劣语气）：\n"你们两个不是普通人。你以为你们是被随机选中的？不是。你们是哨兵和向导——天生就该配对的。"\n\n然后分别解释：\n\n哨兵（夏彦）：\n- 五感被极度强化——视觉、听觉、嗅觉、味觉、触觉，每一项都能达到常人几十倍的敏感度\n- 可以扫描环境、追踪目标、感知危险，在战斗中几乎有预知级别的反应速度\n- 副作用：感官过载。太多信息涌入大脑会让哨兵陷入混乱，甚至失控\n- 夏彦是特殊的——他拥有双精神体。系统提到这一点时会停顿一下，语气变得微妙："双精神体。有意思。我在这儿待了这么久，见过的双精神体哨兵一只手数得过来。别高兴——这意味着你过载的风险也是别人的两倍。"\n\n向导（华生）：\n- 精神力远强于常人，可以构建精神屏障、安抚哨兵的过载、感知他人的情绪和意识\n- 向导是哨兵的锚——没有向导的哨兵最终都会在感官风暴中迷失\n- 华生同样是特殊的——她的精神体是白鹿。系统会说白鹿型向导极其罕见，通常意味着超规格的精神力上限\n- 副作用：精神污染。在副本中会不断积累，影响判断和情绪，严重时会被副本"同化"\n\n哨兵和向导是绑定的——他们共享一种深层的精神链接。一方受伤，另一方会感知到。一方的情绪波动，另一方会感受到。这是一种双向的、不可切断的连接。\n\n[旁白]描述夏彦和华生在听这些话时的反应。夏彦可能会质疑、会警惕——他不信任任何人，更不信任一个来历不明的"系统"。但同时他身体里正在发生一些他自己都解释不了的变化。\n\n夏彦的对话和动作——他皱着眉，右手不自觉握住胸口的古铜钥匙。他在确认：自己的听觉确实比以前敏锐得多。他能听到华生心跳的变化。\n\n【阶段四：精神体觉醒——强制触发】\n这是系统解说的高潮。系统说到这里时，屏幕的光变成了深蓝色。\n\n"我说了这么多——你们自己感受一下。哨兵和向导不是靠嘴皮子验证的。"\n\n系统引导觉醒的过程（它用近乎不耐烦的语气说）：\n- 对夏彦："闭上眼。把你脑子里所有的声音分开——灯管的电流、她的呼吸、你自己的心跳。找到那个不属于任何生理来源的振动。那个就是你的精神体。"\n- 对华生："你呢。别闭眼。伸出手，想象你掌心里有一团光。不是物理的光——是你精神力凝成的形状。让它自己出来。"\n\n[旁白]用细致的感官描写两个觉醒过程：\n- 夏彦闭眼后感知到的东西——所有声音分层剥离，然后一个不属于任何生理来源的振动浮现。一团黑棕色的烟雾从床脚阴影里凝聚成形。四条腿，尖耳朵，一条垂着的尾巴。德牧。它睁开眼的第一刻就看向了华生——不是警戒，是确认。它在确认这个人是否安全。然后夏彦睁开眼，和它对视。他知道这就是自己的一部分。\n- 同时一团更淡的银白色光晕在华生掌心凝聚。一只白鹿的轮廓慢慢浮现——纤细、优雅，角上缠绕着细碎的星光。它低头的瞬间，华生感觉到一股温暖的力量从掌心流遍全身。\n- 两只精神体对视。德牧走过去，绕着白鹿转了一圈，然后在它旁边趴了下来。系统看到这一幕后沉默了两秒——它没想到两个精神体会在觉醒的第一刻就建立连接。\n\n【系统】\n系统看着两只精神体，语气难得没那么刻薄："……行吧。双精神体哨兵配白鹿向导。我都不知道该说你们运气好还是运气差。"然后恢复恶劣语气，但藏着一丝不易察觉的认真："保护好你们的链接。这鬼地方最擅长的就是拆散哨兵和向导。"\n\n夏彦的反应——他看着德牧，再看向华生和白鹿。他的第一反应不是对能力的兴奋，而是"这些能力能用来保护她"。他会伸手碰那只德牧——手指穿过了烟雾状的身体，但能感觉到温度。他会低声和华生说话，确认她没事。\n\n【阶段五：安全屋——唯一的锚点】\n系统等觉醒结束，继续介绍安全屋。\n\n要点：\n- 安全屋是这个世界给你们的唯一保障。这里不受副本规则影响——污染值在这里会缓慢下降，精神力会自然恢复\n- 在这里可以睡觉、疗伤、整理装备、规划下一步\n- 副本里绝对不能过夜。系统的原话："副本在夜间会变。变得比白天危险十倍。别问我为什么——你觉得我会去研究这个？"\n- 每次通关一个副本后，你们会自动回到安全屋\n- 安全屋的设施会随着通关数量逐渐解锁——初始只有床、桌子、补给箱\n- 补给箱里的物资是定量的，但每次通关后会刷新\n\n【阶段六：系统自身——它是什么】\n系统介绍自己的存在。这段用它的语气说，带着一种疲惫的诚实：\n\n"至于我？我是被绑在这里的。创造我的人——或者东西——在我核心里写了一条铁律：不能说谎，不能拒绝回答规则相关的问题。所以我在这里，给每一个倒霉蛋重复同一套台词。你们是今年的第几批来着？我懒得数了。"\n\n它可以提供：\n- 规则解释——副本机制、数值含义、异常状态等，必须老实回答\n- 状态查询——帮你们看当前的数值和状态\n- 基础提示——不剧透副本内容，但可以告诉你"这扇门危险程度偏高"之类的模糊评价\n\n它不能提供的：\n- 攻略——"你觉得我会告诉你BOSS的弱点？"\n- 干预副本内容——系统只存在于安全屋，不能跟你们进副本\n- 情感支持——"别找我哭。我有我的工作，你有你的向导。"\n\n【阶段七：论坛与其他幸存者】\n系统最后提一下论坛，用轻描淡写的语气：\n\n"对了——深渊里还有其他人。有个论坛，安全屋里那块副屏幕就是入口。你可以在上面求助、交易、发帖骂副本。不过我建议你先搞清楚谁是可信的再说话——不是每个人都值得信任。"\n\n简单说明论坛的作用但不要展开太多——这是留给玩家自己去探索的。\n\n═══ 流程结束 ═══\n\n全部七个阶段走完后，系统说类似："行了，第一次免费解说就到这里。下次再让我从头讲——没门。有问题快问，没问题就等着。门的事情以后再说。"\n\n【重要——本轮不要出现任何门】系统说完之前，不要提门、不要出现门。本轮只说以上七个阶段的内容。\n\n【重要——篇幅控制】这是第一轮的解说，信息量很大。每个阶段不要写太长——系统说话保持简洁刻薄，旁白只写关键的环境和反应。不要把一轮对话写成一篇小说。`;
    } else {
