...
export async function playerAction(actionText) {
  ...
  const userContent = `${ctx}${phaseHint}\n\n华生的行动：${actionText}\n\n请生成接下来的场景。用自然散文体——夏彦的动作和对话直接融入叙述中，不使用任何括号标记。\n\n【铁则】\n1. 【纯散文格式——不使用任何括号】夏彦的动作直接写成叙述的一部分：'"阿鹿。"他走到她身边蹲下来，手指搭上她的手腕。'括号（）在本游戏中完全禁用。\n2. 禁止"不是...，是..."句式。\n3. 夏彦每段对话1-3句就停，等玩家回应。\n4. 【禁止替华生写任何东西——最高铁则】华生的一切由玩家输入决定。禁止描写华生的动作、表情、反应、语言、心理。\n5. 【叙述视角】夏彦第三人称有限视角。"他"=夏彦，"华生"或"她"=华生。绝不使用"你"。所有信息通过夏彦的感知传递。\n6. 【主动引导】多数时候主动判断局势、带头行动，只在关键时刻征询她的意见。\n7. 【NPC对话归属】NPC对话和互动写在叙述里，夏彦不替NPC说话。\n8. 【其他幸存者】每个世界至少出现一队其他哨向搭档或幸存者。\n9. 【向哨能力】夏彦每轮至少使用一项哨兵五感，华生的向导能力必须体现。\n10. 【数值变化——代码自动漂移，你只报重大事件】代码漂移公式：探索 同步率-1~2/轮 过载+1~3/轮 | BOSS 同步率-2~7/轮 过载+3~7/轮 | 安全屋 精神力+5~10/轮 过载-3~7/轮。你只在战斗受伤/精神屏障/深度扫描/污染源/BOSS特殊攻击/精神体受伤时输出【数值变化】块。\n11. 【BOSS时机】进入副本6-10轮内推进到BOSS。华生精神力<40或污染值>45时加速。\n12. 【夏彦的情绪真实感】她受伤→你急，危险的事直接上，她逞强时压住她。\n\n【系统通知——关键时刻】发现关键线索/关键地点/重大危险时插入【系统】通知块。平均4-6轮最多一次。\n\n【必须生成选项】回复末尾给出3个建议行动：\n【选项】\n- 选项1\n- 选项2\n- 选项3`;
