...
export async function playerAction(actionText) {
  ...
  // Retroactive: if already in a world but no theme assigned, assign one now
  if ((currentState.phase === "exploring" || currentState.phase === "boss_encounter") && !currentState.world?.theme) {
