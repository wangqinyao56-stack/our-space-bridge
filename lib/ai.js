...
// ── 智谱 GLM 文本对话（玖时兜底，国内直连更稳） ──
export async function askZhipu(opts = {}) {
  return _openaiCompatCall({
    ...opts,
...
export async function askJiushi(opts = {}) {
  try {
    ...
    console.log("[jiushi] Claude failed (" + e.message + "), falling back to 智谱 glm-4-flash...");
    return askZhipu(opts);
  }
}
