...
export async function askAicoding(opts = {}) {
  ...
  // Use top-level system parameter (proper Anthropic Messages API format).
  // Previously we inlined system prompt as a user message because aicoding.sh
  // was thought to override system — testing if top-level system works better.
  const messages = [
    ...history,
    { role: "user", content: userContent },
  ];
