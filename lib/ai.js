...
const XIONGMAO_MODEL = "熊猫-特供-A-55-claude-opus-4.6";
...
export async function askJumengai(opts = {}) {
  return _openaiCompatCall({
    ...opts,
    model: opts.model || JUMENGAI_MODEL,
    host: JUMENGAI_HOST,
    apiKey: JUMENGAI_KEY,
