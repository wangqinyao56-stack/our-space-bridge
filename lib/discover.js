...
function extractSceneKeyword(text) {
  const map = [
    ...
    { pattern: /花|开花|花朵|花海/, keyword: "beautiful flowers garden" },
    { pattern: /咖啡|拿铁|美式|卡布奇诺/, keyword: "coffee latte cafe" },
    { pattern: /蛋糕|甜点|面包|烘焙/, keyword: "dessert pastry baking" },
    { pattern: /树|树林|森林|大树/, keyword: "forest trees nature" },
    { pattern: /海|海滩|海边|海浪/, keyword: "ocean beach waves" },
    { pattern: /山|山顶|山峰/, keyword: "mountain peak landscape" },
    { pattern: /河|湖|水|溪/, keyword: "river lake water nature" },
    { pattern: /雪|下雪|雪景/, keyword: "snow winter landscape" },
    { pattern: /日落|夕阳|晚霞|黄昏/, keyword: "sunset golden hour" },
    { pattern: /月亮|星空|星星|夜空/, keyword: "night sky moon stars" },
    { pattern: /雨|下雨|雨天|雨滴/, keyword: "rain window cozy" },
    { pattern: /书|看书|阅读|图书馆/, keyword: "book reading cozy" },
    { pattern: /植物|盆栽|多肉|阳台|绿植/, keyword: "potted plant greenery" },
    { pattern: /食物|美食|好吃|做饭|下厨|菜/, keyword: "food photography dish" },
    { pattern: /公园|散步|户外|街头/, keyword: "park nature path scenery" },
    { pattern: /拍照|照片|拍张|拍下来/, keyword: "beautiful scenery photography" },
  ];
...
maxTokens: 400,
  ...
  const imageKeyword = animalKeyword || sceneKeyword || title || scene.imageKeyword;
