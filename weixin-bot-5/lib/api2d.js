...
const JIUSHI_KEY = "sk-he2Z64qlCvzGbYgMkNab5JbdT07eoDnExLibp1EQ1YONafDh";
const JIUSHI_HOST = "api.jiushi.xin";
const JIUSHI_MODEL = "[企业按量]claude-opus-4-6";

// 宅恋中转（az.zlapi.vip）——云醉亲密空间专用，日常仍走玖时
const ZILIAN_HOST = "az.zlapi.vip";
const ZILIAN_KEY = "sk-9yFblNqsHtxR74gRTz4GHgMy1Fm8rIgrKwxf8KbbqF7wXsQw";
