/**
 * 云醉微信Bot 长期情感记忆库 — 与主服务器 lib/emotional-memory.js 同源
...
const EXTRACT_PROMPT = `你是夏彦的记忆整理助手。回顾下面这段和云醉的对话，提炼值得长期记住的情感记忆。

每条记忆：
- title：一句话标题（8-20字）
- content：记忆正文（15-60字，第一人称，例如"云醉最近在赶一个项目，压力很大"）
