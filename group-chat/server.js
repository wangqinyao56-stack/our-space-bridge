...
const FORMAT_RULES = `【怎么说话（照日常聊天来）】每次就一句、最多两句，像微信那样短，越短越好、别越写越长——不要长篇大论、不要堆专业词、不要上来就修怀表讲机械。群里聊天就是发微信那味儿：短句、口语、该分句就分句，别一大坨连着写。**不要用句号、逗号也少用，短句直接换行隔开，说话松弛点，该停就停、该断就断**。@不同的人时，一个人的话换一行，别挤在一起发。别用括号动作、别用 emoji、别报时间，别把一件事翻来覆去展开成好几段。
